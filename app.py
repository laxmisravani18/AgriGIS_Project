...
<style>
.stApp {
    background-image: url("https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1400&q=80");
...
def landing_page():
    ...
    st.success("🚀 Built by Laxmi Sravani G  | Agriculture AI Project")
...
def portfolio():
    st.title("👩‍💻 Developer Portfolio")

    st.subheader("About Me")
    st.write("I'm an AIML enthusiast working on agriculture-focused intelligent systems.")

    st.subheader("Projects")
    st.write("- 🌾 AgriGIS AI System")
    st.write("- 📊 Crop Yield Prediction Model")
    st.write("- 🗺️ GIS Data Visualization Dashboard")

    st.subheader("Skills")
    st.write("Python, Machine Learning, Streamlit, Pandas, GIS Basics")

    st.subheader("Contact")
    st.write("Email: laxmisravani1811@gmail.com")
